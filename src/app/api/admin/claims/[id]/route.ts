...
export async function PUT(
  ...
  try {
    ...
    if (actionData.actualDamageAmount !== undefined) updateData.actualDamageAmount = actionData.actualDamageAmount;
    if (actionData.settlementAmount !== undefined) updateData.settlementAmount = actionData.settlementAmount;
