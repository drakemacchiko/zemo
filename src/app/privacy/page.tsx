      ...
      <div className="prose max-w-none space-y-6">
        <section>
          ...
          <p className="text-gray-700">
            ...
            phone number, payment information, and driving license details.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            We share information with hosts and renters as necessary to facilitate bookings, 
            with service providers who assist in our operations, and as required by law.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            Contact us at privacy@zemo.zm to exercise these rights.
          </p>
        </section>
