...
function NewBookingForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!token) {
      router.push(
        `/login?redirect=/bookings/new?vehicleId=${vehicleId}&start=${startDate}&end=${endDate}`
      );
      return;
    }
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-zemo-yellow px-6 py-2 rounded-lg"
          >
            Back to Search
          </button>
        </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {vehicle.vehicleType} • {vehicle.transmission}
                  </p>
                  ...
                  <label className="flex items-start p-4 border rounded-lg cursor-pointer hover:border-zemo-yellow">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        You'll be fully responsible for any damages
                      </p>
                    </div>
                  </label>
                  ...
                  {insuranceOptions.map(option => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          Coverage: ZMW {option.coverageAmount.toLocaleString()}
                        </p>
                      </div>
                    </label>
                  ))}
