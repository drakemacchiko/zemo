      ...
      <div className="prose max-w-none space-y-6">
        <section>
          ...
          <p className="text-gray-700">
            By accessing and using ZEMO, you accept and agree to be bound by the terms and provision
            of this agreement.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            before vehicle pickup. Cancellation policies vary by host.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            You agree to use the vehicle responsibly, comply with all traffic laws, and return the
            vehicle in the same condition as received. You are responsible for any damage or traffic
        ...
        <section>
          ...
          <p className="text-gray-700">
            Insurance coverage is mandatory for all rentals. You must select an insurance option at
            the time of booking. Coverage details and limitations are outlined in your policy.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            ZEMO acts as a platform connecting hosts and renters. We are not responsible for the
            condition, safety, or legality of vehicles listed on our platform.
          </p>
        </section>
