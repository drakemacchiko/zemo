      ...
      <div className="max-w-md bg-white rounded-lg shadow-md p-8 text-center">
        ...
        <div className="space-y-3">
          <Link
            ...
            className="block bg-zemo-yellow hover:bg-yellow-400 py-3 rounded-lg font-bold"
          >
            View Booking Details
          </Link>
          <Link
            href="/bookings"
            className="block bg-gray-100 hover:bg-gray-200 py-3 rounded-lg font-semibold"
          >
            View All Bookings
          </Link>
        </div>
